...
public class Localization : INotifyPropertyChanged
{
    ...
    static readonly Dictionary<string, Dictionary<string, string>> _t = new()
    {
        ["en"] = new()
        {
            ...
            ["window_success"] = "Success (60s)",
            ["window_errors"] = "Errors (60s)",
            ["window_requests"] = "Requests (60s)",
            ...
            ["allow_lan"] = "Allow LAN (listen on all interfaces)",
            ["port"] = "Port",
            ...
            ["reset_system_state"] = "Reset System State",
            ["done"] = "Done",
            ["language"] = "Language",
        ...
        ["fa"] = new()
        {
            ...
            ["window_success"] = "موفقیت (۶۰ث)",
            ["window_errors"] = "خطاها (۶۰ث)",
            ["window_requests"] = "درخواست‌ها (۶۰ث)",
            ["peak_connections"] = "اوج اتصال",
            ...
            ["allow_lan"] = "اجازه دسترسی LAN (گوش دادن روی همه اینترفیس‌ها)",
            ["port"] = "پورت",
            ...
            ["reset_system_state"] = "بازنشانی کامل وضعیت سیستم",
            ["done"] = "تمام",
            ["language"] = "زبان",
